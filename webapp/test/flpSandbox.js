		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Team ",
									"targetURL": "#comsapteamdashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapteamdashboard-display": {
								"semanticObject": "comsapteamdashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.teamdashboard",
									"url": sap.ui.require.toUrl("com/sap/teamdashboard")
								}
							}
						}
					}
